...
try {
  ...
  (function UseRestParameter() {
    ...
    function foo(a, b, ...c) {
      // Fant ut dette ved å teste å sjekke sammenhengen mellom type of c
      // og hvordan siste tallet skal bli 3 og 4. Jeg fant ut at siste tallet
      // er lengden av object c.
